    ...
    return (
        <div className="border-b border-gray-100 py-4 last:border-0">
            <button
                ...
                className="flex items-center justify-between w-full mb-3 text-sm font-semibold text-gray-800 hover:text-blue-600 transition-colors"
            >
                {title}
...
export const Sidebar = () => {
    return (
        <aside className="w-full lg:w-72 bg-white rounded-xl shadow-sm border border-gray-100 p-6 h-fit sticky top-24">
            <div className="flex items-center gap-2 mb-6 text-gray-900 border-b border-gray-100 pb-4">
                <Filter className="w-5 h-5 text-blue-600" />
                <h2 className="font-bold text-lg">Filter Talent</h2>
            </div>
                ...
                {['ChatGPT', 'Midjourney', 'Python', 'LangChain', 'Stable Diffusion'].map((stack) => (
                    <label key={stack} className="flex items-center gap-3 cursor-pointer group">
                        <div className="relative flex items-center">
                            <input type="checkbox" className="peer w-4 h-4 appearance-none rounded border border-gray-300 checked:bg-blue-600 checked:border-blue-600 transition-all cursor-pointer" />
                        ...
                        <span className="text-sm text-gray-600 group-hover:text-gray-900 transition-colors">{stack}</span>
                    </label>
                ))}
            </FilterSection>
            ...
            <FilterSection title="Availability">
                <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <span className="text-sm font-medium text-gray-700">Available this week</span>
                </label>
            </FilterSection>

            <div className="mt-4 pt-4 border-t border-gray-100">
                <label className="text-sm font-semibold text-gray-800 mb-2 block">Experience (Years)</label>

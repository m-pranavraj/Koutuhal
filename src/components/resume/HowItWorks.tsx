            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">
                        How it Works <span className="text-purple-600">(Like Magic)</span>
                    </h2>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-4 h-auto lg:h-[500px]">
                    {steps.map((step) => {
                        ...
                        return (
                            <motion.div
                                key={step.id}
                                className={`relative rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 ease-in-out border ${isHovered ? 'border-purple-200 ring-4 ring-purple-100 dark:ring-purple-900/30' : 'border-gray-200 dark:border-slate-800'}`}
                            ...
                            >
                                ...
                                {isHovered ? (
                                    <div className="absolute inset-0 bg-purple-100 dark:bg-purple-900/20 z-0" />
                                ) : (
                                ...
                                <div className="relative z-10 p-8 flex flex-col h-full">
                                    ...
                                    <h3 className={`text-xl font-bold mb-4 transition-colors ${isHovered ? 'text-purple-900 dark:text-purple-100' : 'text-slate-900 dark:text-white'}`}>
                                        {step.title}
                                    </h3>
                                    ...
                                    >
                                        <step.icon className={`w-12 h-12 ${isHovered ? 'text-purple-600' : 'text-slate-300'}`} />
                                    </motion.div>
